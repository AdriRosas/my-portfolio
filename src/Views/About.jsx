    ...
    <div className={styles.aboutContent}>
      <div className={styles.aboutTextContainer}>
        ...
        <p className={styles.aboutMeDescription}>
          ...
          aplicaciones web con Javascript, Vue y React. Tengo un gran interés en
          tecnologías como Blockchain y modelos de aprendizaje automático.
        </p>
        <div className={styles.aboutMeDescription}>
          SKILLS:<br />
          <strong>Lenguajes de Programación:</strong> Intermedio: Javascript;
          Básico: Solidity<br />
          <strong>Frameworks:</strong> Intermedio: Vue 2; Básico: Vue 3,
          React<br />
          <strong>Base de Datos:</strong> Firebase<br />
          <strong>Herramientas:</strong> Git, GitFlow, Vuex, Vuetify, Slack,
          Kanban, Adobe XD, Figma, Photoshop, Illustrator, Stable Diffusion<br />
